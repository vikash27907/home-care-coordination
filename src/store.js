...
const NURSE_UPDATE_FIELD_MAP = {
  ...
  aadhaarFrontUrl: 'aadhar_front_url',
  aadharFrontUrl: 'aadhar_front_url',
  aadhaarBackUrl: 'aadhar_back_url',
  aadharBackUrl: 'aadhar_back_url',
  aadhaarCardUrl: 'aadhar_image_url',
  height: 'height_text',
